...
<html dir="ltr" lang="en">
    ...
    <body>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                   aria-haspopup="true" aria-expanded="false">
                                    <img src="resources/assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                         width="40">
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-7 align-self-center">
                            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Registro de Marca</h4>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Registro Marca</h4>

                                    <form class="mt-3" action="save_marca" method="post">

                                        <div class="form-group">
                                            <input name="nombre" type="text" class="form-control" id="nametext" aria-describedby="name"
                                                   placeholder="Name">
                                        </div>

                                        <div class="form-group">
                                            <input name="descripcion" type="text" class="form-control" id="descaripcionText" aria-describedby="name"
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle"> Esta es la lista de las marcas registradas</h6>
                                </div>
        ...
        <script src="resources/dist/js/app.init-menusidebar.js"></script>
